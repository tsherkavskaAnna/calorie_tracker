...
const RegisterPage = () => {
	...
	const usernameHandler = (text: string) => setUsername(text);
	...
	return (
		<TouchableWithoutFeedback onPress={Keyboard.dismiss}>
			<ImageBackground
				...
				className="flex-1 size-cover justify-start bg-neutral-200"
			>
				<View className="grid px-6 pt-20 gap-4">
					...
					>
						...
						<TextInput
							placeholder="Email"
							className="border border-violet-600 px-4 py-4 bg-slate-50 rounded-lg color-slate-600 shadow-md shadow-slate-200 mb-4 focus:border-green-500"
							value={username}
						...
						<TouchableOpacity
							activeOpacity={0.8}
							onPress={onLogin}
							className="align-baseline items-center rounded-lg px-4 py-4 bg-violet-500 focus:bg-violet-600 mb-4"
						>
